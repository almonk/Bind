var AddElement = React.createClass({displayName: "AddElement",
  ...
  componentWillUpdate: function(nextProps, nextState) {
    if (nextProps.visiblility === false) {
      this.props.handleExit();  
    };
  },
  ...
  render: function() {
    ...
    var classes = cx({
      ...
      'is-hidden': this.state.isAdding
    });

    var inputClasses = cx({
      'modal-input': true,
      'is-active': this.state.isAdding && this.props.visiblility
    });

    var modalClasses = cx({
      'modal': true,
      'is-active': this.props.visiblility,
      'is-dark': this.state.isAdding
    });
    ...
    return (
      React.createElement("div", null, 
        ...
        React.createElement("div", {className: inputClasses}, 
          ...
          React.createElement("input", {className: "modal__input--large", type: "text"})
        ), 
