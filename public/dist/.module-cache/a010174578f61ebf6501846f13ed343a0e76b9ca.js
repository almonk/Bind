var AddConnection = React.createClass({displayName: "AddConnection",
  addConnections: function(e) {
    ...
    var direction = $('.add-connection input[value=direction]:checked').val();
      ...
      React.createElement("div", null, 
        React.createElement("div", {className: classes}, 
          ...
          React.createElement("div", {className: "add-constraint__element"}, 
            ...
            React.createElement("label", null, React.createElement("input", {type: "radio", name: "direction", checked: true, value: "h"}), "Horizontal"), 
