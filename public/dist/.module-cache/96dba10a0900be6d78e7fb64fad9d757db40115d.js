var Editor = React.createClass({displayName: "Editor",
  componentDidMount: function() {
    ...
    window.addEventListener('willPlaceImage', this.toggleProperties);
  },
  ...
  componentWillUnmount: function() {
    ...
    window.removeEventListener('willPlaceImage', this.toggleProperties);
  },
  ...
  willPlaceImage: function() {
    MacGap.Dialog.openDialog({files: true, callback: function(file){
      console.log(file);
      htmlEditor.replaceRange("<img src='file://"+file.filePath+"'/>\n", {line: Infinity});
    }});
  },
