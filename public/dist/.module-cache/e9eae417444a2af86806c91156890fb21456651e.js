    ...
    return (
      React.createElement("div", null, 
        ...
        React.createElement("div", {className: colTwoClasses}, 
          React.createElement("div", {className: "properties-panel__element-name"}, this.props.multipleSelectedElements.length, " Elements selected"), 
          React.createElement("a", {href: "#", className: "properties-panel__button", onClick: this.addConstraint}, "Add connection")
        )
      )
    );
  }
