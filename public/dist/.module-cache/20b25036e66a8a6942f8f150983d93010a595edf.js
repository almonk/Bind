      ...
      React.createElement("div", null, 
        React.createElement("div", {className: classes}, 
          ...
          React.createElement("div", {className: "add-constraint__element"}, 
            ...
            React.createElement("label", {className: "add-constraint__element__label"}, React.createElement("input", {type: "radio", name: "direction", defaultChecked: this.state.isHorizontal, value: "h"}), "Horizontal"), 
            React.createElement("label", {className: "add-constraint__element__label"}, React.createElement("input", {type: "radio", name: "direction", defaultChecked: this.state.isHorizontal, value: "v"}), "Vertical")
          ), 
