  ...
  render: function() {
    return (
      React.createElement("div", {className: "COL properties-panel"}, 
        ...
        React.createElement("a", {href: "#", className: "properties-panel__buton", onClick: this.addIntrinsicSize}, "Add intrinsic size"), 

        React.createElement("a", {href: "#", className: "properties-panel__buton", onClick: this.addConstraint}, "Add constraint")
      )
    );
  }
});
