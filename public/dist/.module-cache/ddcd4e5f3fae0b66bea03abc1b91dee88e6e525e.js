var PropertiesPanel = React.createClass({displayName: "PropertiesPanel",
  ...
  render: function() {
    ...
    return (
      React.createElement("div", {className: "properties-parent"}, 
        ...
        React.createElement("div", {className: colTwoClasses}, 
          ...
          React.createElement("a", {href: "#", className: "properties-panel__button", onClick: this.addIntrinsicSizeAll}, "Add intrinsic size to all"), 
          React.createElement("a", {href: "#", className: "properties-panel__button", onClick: this.addConstraintToAll}, "Add constraint to all"), 
