  ...
  render: function() {
    return (
      React.createElement("div", {className: "COL properties-panel"}, 
        ...
        React.createElement("a", {href: "#", className: "properties-panel__button", onClick: this.addIntrinsicSize}, "Add intrinsic size"), 

        React.createElement("a", {href: "#", className: "properties-panel__button", onClick: this.addConstraint}, "Add constraint")
      )
    );
  }
});
