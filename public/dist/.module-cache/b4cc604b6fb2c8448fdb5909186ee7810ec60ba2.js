var AddConnection = React.createClass({displayName: "AddConnection",
  addConnections: function(e) {
    ...
    $('.add-connection input[type=text]').each(function () {
      var element = $(this).attr('id');
      
      gssEditor.replaceRange("@h ("+selected[0]+")("+selected[1]+");\n", {line: Infinity});
    });
  },
      ...
      React.createElement("div", null, 
        React.createElement("div", {className: classes}, 
          ...
          React.createElement("div", {className: "add-constraint__element"}, 
            ...
            React.createElement("input", {type: "radio", name: "direction", value: "h"}), "Horizontal", 
            React.createElement("input", {type: "radio", name: "direction", value: "v"}), "Vertical"
          ), 
