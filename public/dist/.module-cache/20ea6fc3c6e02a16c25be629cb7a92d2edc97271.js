var AddConstraint = React.createClass({displayName: "AddConstraint",
  ...
  focusAndCheck: function(event) {
    console.log(this.getDOMNode());
    this.getDOMNode().prev('input[type=checkbox]').attr('checked', true);
  },
      ...
      React.createElement("div", null, 
        React.createElement("div", {className: classes}, 
          React.createElement("div", {className: "add-constraint__element"}, 
            ...
            React.createElement("input", {onFocus: this.focusAndCheck, type: "text", id: "bind-width-value"})
          ), 
          ...
          React.createElement("div", {className: "add-constraint__element"}, 
            ...
            React.createElement("input", {onFocus: this.focusAndCheck, type: "text", id: "bind-height-value"})
          ), 
          ...
          React.createElement("div", {className: "add-constraint__element"}, 
            ...
            React.createElement("input", {onFocus: this.focusAndCheck, type: "text", id: "bind-top-value"})
          ), 
          ...
          React.createElement("div", {className: "add-constraint__element"}, 
            ...
            React.createElement("input", {onFocus: this.focusAndCheck, type: "text", id: "bind-bottom-value"})
          ), 
          ...
          React.createElement("div", {className: "add-constraint__element"}, 
            ...
            React.createElement("input", {onFocus: this.focusAndCheck, type: "text", id: "bind-left-value"})
          ), 
          ...
          React.createElement("div", {className: "add-constraint__element"}, 
            ...
            React.createElement("input", {onFocus: this.focusAndCheck, type: "text", id: "bind-right-value"})
          ), 
