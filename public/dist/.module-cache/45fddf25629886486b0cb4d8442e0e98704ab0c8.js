  ...
  render: function() {
    return (
      React.createElement("div", {className: "EXTENDER"}, 
        ...
        React.createElement(AddMultipleConstraint, {visiblility: this.state.addMultipleConstraintVisiblility, selectedElements: this.state.multipleSelectedElements}), 
        React.createElement(AddConnection, {visiblility: this.state.addConnectionVisibility, selectedElements: this.state.multipleSelectedElements}), 
